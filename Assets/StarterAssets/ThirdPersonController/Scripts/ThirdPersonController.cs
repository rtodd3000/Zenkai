...
namespace StarterAssets
{
    ...
    {
        // ← NEW: allow other scripts to toggle “climbing” mode
        ...
        private void Update()
        {
            // if we're in climbing mode, just drive the climbing animation and skip the rest
            if (isClimbing)
            {
                if (_hasAnimator)
                    _animator.SetBool(_animIDIsClimbing, true);
                return;
            }
        ...
        private void Move()
        {
            ...
            if (_hasAnimator)
            {
                ...
                // always update our climbing flag so exit transitions work
